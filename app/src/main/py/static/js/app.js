...
function updateMobilePlayerUI() {
    ...
    if (dlBtn) {
        const isDl = Store.isDownloaded(track.id);
        dlBtn.classList.toggle('active', isDl);
        dlBtn.innerHTML = isDl ? ICONS.downloadCheck : ICONS.download;
    }
    ...
    overlay.innerHTML = `
        ...
        <div class="mobile-player-content">
            ...
            <div class="mobile-player-footer">
                ...
                <button class="btn-icon ${Store.isDownloaded(track.id) ? 'active' : ''}" id="mobile-download-btn" onclick="downloadCurrentTrack(this)" title="Download" style="display:flex;align-items:center;justify-content:center">
                    ${Store.isDownloaded(track.id) ? ICONS.downloadCheck : ICONS.download}
                </button>
